# Act 3 - Scene 2: Medical X-Ray FHE Demo - TenSEAL Linear Triage
# Mã số file code đích: scenes/03_demos/scene_02_xray_triage.py
...
### Phân đoạn 2.1: Đặt vấn đề Y tế & Trích xuất Đặc trưng tại Edge (00:00 - 03:30)
...
### Phân đoạn 2.2: Đóng gói TenSEAL & Mã hóa CKKS (03:30 - 07:30)
- **Lời thoại AI (Audio Voiceover):**
...
### Phân đoạn 2.3: Tính toán Hồi quy Tuyến tính Đồng hình (07:30 - 11:30)
- **Lời thoại AI (Audio Voiceover):**
...
### Phân đoạn 2.4: Giải mã & Kích hoạt Phi tuyến tính (Sigmoid) tại Client (11:30 - 15:00)
- **Lời thoại AI (Audio Voiceover):**
...
- **Phân đoạn 2.1:** Giải thích lý do Edge Computing được sử dụng để giảm băng thông (chuyển ma trận ảnh lớn thành 10 thông số đặc trưng).
- **Phân đoạn 2.2:** Giới thiệu ngắn về thư viện TenSEAL của OpenMined, tại sao nó lại là "cầu nối" hoàn hảo giữa Data Science và FHE.
- **Phân đoạn 2.3:** Phân tích trực quan phép toán Dot Product đồng hình ($Enc(X) \cdot W$) và lý do phép toán này tốn rất ít độ sâu nhân (Multiplicative Depth = 1).
- **Phân đoạn 2.4:** Nhấn mạnh sự thông minh trong việc **chia cắt Pipeline (Split Pipeline)**: Giao phần nặng nhọc (nhân ma trận) cho Cloud, giao phần phi tuyến tính (Sigmoid) cho Client xử lý ở dạng Plaintext để tiết kiệm tài nguyên FHE tối đa.